 ...
 * VERSÃO CORRIGIDA: Garante que todos os gêneros geram playlists para todos os estados emocionais
 */
 ...
 * CORRIGIDO: Cada gênero tem regras para todos os estados emocionais
 */
export const GENRE_SPECIFIC_RULES: FuzzyRule[] = [
  ...
  {
    id: 'FUNK1',
    description: 'Funk com estado TRISTE gera intenção ESTIMULANTE para animação',
    antecedent: {
      variable: 'estado_emocional',
      value: 'triste'
    },
  ...
  {
    id: 'FUNK2',
    description: 'Funk com estado ANSIOSO gera intenção ESTIMULANTE para liberação',
    antecedent: {
      variable: 'estado_emocional',
      value: 'ansioso'
    },
 ...
 * CORRIGIDO: Cada gênero tem 4 regras (uma para cada estado emocional)
 */
 ...
 * NOVO: Ajustes finos baseados no gênero musical
 */
export const GENRE_EMOTIONAL_MODIFIERS: Record<string, Record<string, Partial<EmotionalCriteria>>> = {
  'MPB': {
 ...
 */
export function getGenreRuleStats(): Record<string, { totalRules: number; ruleIds: string[] }> {
